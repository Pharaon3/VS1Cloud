...
Template.supplierawaitingpurchaseorder.onCreated(function () {
    ...
    templateObject.getDataTableList = function(data) {
        ...
        if ((data.Type == "Purchase Order") || (data.Type == "Bill") || (data.Type == "Credit")) {
            var dataList = [
                ...
                '<div class="custom-control custom-switch chkBox chkPaymentCard pointer text-center" overduetype="'+overDueType+'"><input name="pointer" class="custom-control-input chkBox notevent pointer" type="checkbox" id="f-' + data.PurchaseOrderID + '" name="' + data.PurchaseOrderID + '" value="' + totalOutstanding + '"><label class="custom-control-label chkBox pointer" for="f--' + data.PurchaseOrderID + '"></label></div>',
                overDueDaysText,
    ...
    let headerStructure = [
        ...
        {index: 1, label: "checkBoxHeader", class: "colCheckBox", width: "15", active: true, display: false},
        {index: 2, label: "Overdue", class: "colOverdueDays", width: "80", active: true, display: true},
        ...
        {index: 8, label: "Original", class: "colApplied", width: "80", active: true, display: true},
