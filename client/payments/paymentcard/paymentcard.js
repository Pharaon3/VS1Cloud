...
Template.paymentcard.events({
    ...
    setTimeout(async function(){
        var printTemplate = [];
        LoadingOverlay.show();
        var customer_payment = $('input[name="CustomerPayment"]:checked').val();
        ...
        if (printTemplate.length > 0) {
            for (var i = 0; i < printTemplate.length; i++) {
                if (printTemplate[i] == 'Customer Payment') {
                    var template_number = $('input[name="CustomerPayments"]:checked').val();
                }
    ...
    'click #printModal .btn-check-template': async function (event) {
        ...
        setTimeout(async function(){
            ...
            $('#html-2-pdfwrapper').css('display', 'block');
            var template_number = $('input[name="CustomerPayment"]:checked').val();
