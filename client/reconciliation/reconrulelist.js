...
Template.reconrulelist.onCreated(function(){
    ...
    templateObject.getDataTableList = function(data) {
        let openBalance = utilityService.modifynegativeCurrencyFormat(data.fields.OpenBalance)|| 0.00;
        let closeBalance = utilityService.modifynegativeCurrencyFormat(data.fields.CloseBalance)|| 0.00;
        const dataList = [
            data.fields.ID || '',
            data.fields.BankRuleName || '',
            data.fields.BankRuleType || '',
            data.fields.Comment || '',
    ...
    let headerStructure = [
        ...
        { index: 1, label: 'Rule Name', class:'colBankRuleName', active: true, display: true, width: "80" },
        { index: 2, label: "Spent/Received", class: "colBankRuleType", active: true, display: true, width: "80" },
        { index: 3, label: "Comment", class: "colComment", active: true, display: true, width: "110" },
        { index: 4, label: "Status", class: "colStatus", active: true, display: true, width: "110" },
    ];
...
Template.reconrulelist.helpers({
    ...
    apiFunction:function() {
        let sideBarService = new SideBarService();
        return sideBarService.getAllBankRuleList;
    },
