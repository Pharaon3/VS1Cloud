...
Template.reconciliationlist.onCreated(function(){
    ...
    let headerStructure = [
        ...
        { index: 3, label: "Statment No.", class: "colStatmentNo11", active: false, display: true, width: "10" },
        { index: 4, label: "Recon", class: "colRecon", active: false, display: true, width: "10" },
        { index: 5, label: "Department", class: "colDepartment", active: true, display: true, width: "110" },
        { index: 6, label: "Opening", class: "colOpening", active: true, display: true, width: "110" },
        { index: 7, label: "Closing", class: "colClosing", active: true, display: true, width: "110" },
        { index: 8, label: "Employee", class: "colEmployee", active: true, display: true, width: "200" },
        { index: 9, label: "Notes", class: "colNotes", active: true, display: true, width: "300" },
        { index: 10, label: "Finished", class: "colFinished", active: true, display: true, width: "80" },
