...
Template.frmappointmentpop.onRendered(function () {
    ...
    $("#event-modal").on("shown.bs.modal", async function (e) {
        ...
        if (updateID) {
            ...
            var appointment = {
                ...
                sortdate: getAppointmentInfo.fields.CreationDate ? moment(getAppointmentInfo.fields.CreationDate).format("YYYY/MM/DD") : "",
                appointmentdate: getAppointmentInfo.fields.CreationDate ? moment(getAppointmentInfo.fields.CreationDate).format("DD/MM/YYYY") : "",
                ...
                fromDate: getAppointmentInfo.fields.Actual_EndTime ? moment(getAppointmentInfo.fields.Actual_EndTime).format("DD/MM/YYYY") : "",
                openbalance: getAppointmentInfo.fields.Actual_EndTime || "",
                aStartTime: getAppointmentInfo.fields.Actual_StartTime.split(" ")[1] || "",
                aEndTime: getAppointmentInfo.fields.Actual_EndTime.split(" ")[1] || "",
                aStartDate: getAppointmentInfo.fields.Actual_StartTime.split(" ")[0] || "",
                aEndDate: getAppointmentInfo.fields.Actual_EndTime.split(" ")[0] || "",
                actualHours: "",
                closebalance: "",
    ...
    templateObject.checkSMSSettings = function () {
        ...
        if (!accessLevel) {
            ...
            if ((!smsSettings || smsSettings.twilioAccountId === "" || smsSettings.twilioAccountToken === "" || smsSettings.twilioTelephoneNumber === "") && (chkSMSCustomer || chkSMSUser)) {
                swal({
    ...
    $(document).ready(function () {
        ...
        $("#product-list_GP4z5E8SpdZafRfLd").editableSelect();
                        ...
                        if (dataObject.length == 0) {
                            ...
                            sideBarService
                                ...
                                .then(function (data) {
                                    ...
                                    if (
                                        data.tcustomer[0].fields.Street == data.tcustomer[0].fields.BillStreet &&
                                        data.tcustomer[0].fields.Street2 == data.tcustomer[0].fields.BillStreet2 &&
                                        data.tcustomer[0].fields.State == data.tcustomer[0].fields.BillState &&
                                        data.tcustomer[0].fields.Postcode == data.tcustomer[0].fields.BillPostcode &&
                            ...
                            if (currentCustomerIndex > -1) {
                                ...
                                let popCustomerFirstName = data.tcustomervs1[currentCustomerIndex].fields.FirstName || "";
                                let popCustomerMiddleName = data.tcustomervs1[currentCustomerIndex].fields.CUSTFLD10 || "";
                                let popCustomerLastName = data.tcustomervs1[currentCustomerIndex].fields.LastName || "";
                                let popCustomertfn = "" || "";
                                let popCustomerPhone = data.tcustomervs1[currentCustomerIndex].fields.Phone || "";
                                let popCustomerMobile = data.tcustomervs1[currentCustomerIndex].fields.Mobile || "";
                                let popCustomerFaxnumber = data.tcustomervs1[currentCustomerIndex].fields.Faxnumber || "";
                                let popCustomerSkypeName = data.tcustomervs1[currentCustomerIndex].fields.SkypeName || "";
                                let popCustomerURL = data.tcustomervs1[currentCustomerIndex].fields.URL || "";
                                let popCustomerStreet = data.tcustomervs1[currentCustomerIndex].fields.Street || "";
                                let popCustomerStreet2 = data.tcustomervs1[currentCustomerIndex].fields.Street2 || "";
                                let popCustomerState = data.tcustomervs1[currentCustomerIndex].fields.State || "";
                                let popCustomerPostcode = data.tcustomervs1[currentCustomerIndex].fields.Postcode || "";
                                let popCustomerCountry = data.tcustomervs1[currentCustomerIndex].fields.Country || LoggedCountry;
                                let popCustomerbillingaddress = data.tcustomervs1[currentCustomerIndex].fields.BillStreet || "";
                                let popCustomerbcity = data.tcustomervs1[currentCustomerIndex].fields.BillStreet2 || "";
                                let popCustomerbstate = data.tcustomervs1[currentCustomerIndex].fields.BillState || "";
                                let popCustomerbpostalcode = data.tcustomervs1[currentCustomerIndex].fields.BillPostcode || "";
                                let popCustomerbcountry = data.tcustomervs1[currentCustomerIndex].fields.Billcountry || LoggedCountry;
                                let popCustomercustfield1 = data.tcustomervs1[currentCustomerIndex].fields.CUSTFLD1 || "";
                                let popCustomercustfield2 = data.tcustomervs1[currentCustomerIndex].fields.CUSTFLD2 || "";
                                let popCustomercustfield3 = data.tcustomervs1[currentCustomerIndex].fields.CUSTFLD3 || "";
                                let popCustomercustfield4 = data.tcustomervs1[currentCustomerIndex].fields.CUSTFLD4 || "";
                                let popCustomernotes = data.tcustomervs1[currentCustomerIndex].fields.Notes || "";
                                let popCustomerpreferedpayment = data.tcustomervs1[currentCustomerIndex].fields.PaymentMethodName || "";
                                let popCustomerterms = data.tcustomervs1[currentCustomerIndex].fields.TermsName || "";
                                let popCustomerdeliverymethod = data.tcustomervs1[currentCustomerIndex].fields.ShippingMethodName || "";
                                let popCustomeraccountnumber = data.tcustomervs1[currentCustomerIndex].fields.ClientNo || "";
                                let popCustomerisContractor = data.tcustomervs1[currentCustomerIndex].fields.Contractor || false;
                                let popCustomerissupplier = data.tcustomervs1[currentCustomerIndex].fields.IsSupplier || false;
                                let popCustomeriscustomer = data.tcustomervs1[currentCustomerIndex].fields.IsCustomer || false;
                                let popCustomerTaxCode = data.tcustomervs1[currentCustomerIndex].fields.TaxCodeName || "";
                                let popCustomerDiscount = data.tcustomervs1[currentCustomerIndex].fields.Discount || 0;
                                let popCustomerType = data.tcustomervs1[currentCustomerIndex].fields.ClientTypeName || "";
                                let popCompany = data.tcustomervs1[currentCustomerIndex].fields.Companyname || "";
                                //$('#edtCustomerCompany').attr('readonly', true);
                                // $("#edtCustomerCompany").val(popCustomerName);
                                // $("#edtCustomerPOPID").val(popCustomerID);
...
*/
    $(document).on("click", "#employeeListModal_appoinmentlist #tblEmployeelist_appointmentlist tbody tr", function (e) {
        // for taskDetailModal
        ...
        if (overridesettings[0]?.override == "false") {
            document.getElementById("product-list_GP4z5E8SpdZafRfLd").value = calendarSet.defaultProduct || "";
            document.getElementById("product-list-1").value = calendarSet.defaultProduct || "";
        } else if (overridesettings[0]?.override == "true") {
            if (empData.length > 0) {
                document.getElementById("product-list_GP4z5E8SpdZafRfLd").value = empData[empData.length - 1].DefaultServiceProduct || "";
            ...
            if (empData.length > 0) {
                ...
                // $("#product-list_GP4z5E8SpdZafRfLd")[0].options[0].selected = true;
            } else {
                document.getElementById("product-list_GP4z5E8SpdZafRfLd").value = calendarSet.defaultProduct || "";
                document.getElementById("product-list-1").value = calendarSet.defaultProduct || "";
        ...
        $("#employeeListModal_appoinmentlist").modal("toggle");
        $("#event-modal").modal();
        setTimeout(() => {
            if (localStorage.getItem("smsCustomerAppt") == "false") {
                $("#chkSMSCustomer").prop("checked", false);
    ...
    $(document).on("click", "#tblInventoryPayrollService tbody tr", function (e) {
        ...
        $(".product-list_GP4z5E8SpdZafRfLd").val(lineProductName);
        $("#tblInventoryPayrollService_filter .form-control-sm").val("");
        $("#productListModal").modal("toggle");
    ...
    $(document).on("click", "#tblCustomerlist tbody tr", function (e) {
        ...
        if (localStorage.getItem("CloudAppointmentNotes") == true) {
            ...
            document.getElementById("txtNotes-1").value = $(this).find(".colNotes").text();
        }
                ...
                for (let i = 0; i < data.terppreference.length; i++) {
                    switch (data.terppreference[i].PrefName) {
                        case "VS1SMSID":
                            ...
                            break;
                        case "VS1SMSToken":
                            smsSettings.twilioAccountToken = data.terppreference[i].Fieldvalue;
                            break;
                        case "VS1SMSPhone":
                            smsSettings.twilioTelephoneNumber = data.terppreference[i].Fieldvalue;
                            break;
                        case "VS1HEADERSMSMSG":
                            smsSettings.headerAppointmentSMSMessage = data.terppreference[i].Fieldvalue;
                            break;
                        case "VS1SAVESMSMSG":
                            smsSettings.saveAppointmentSMSMessage = data.terppreference[i].Fieldvalue;
                            break;
                        case "VS1STARTSMSMSG":
                            smsSettings.startAppointmentSMSMessage = data.terppreference[i].Fieldvalue;
                            break;
                        case "VS1STOPSMSMSG":
                            smsSettings.stopAppointmentSMSMessage = data.terppreference[i].Fieldvalue;
                    }
                }
                templateObject.defaultSMSSettings.set(smsSettings);
            }
...
Template.frmappointmentpop.events({
    ...
    "click #btnStartAppointment": function () {
        ...
        leaveemployeerecords.forEach((item) => {
            if (item.EmployeeID == empID && startdateGet >= new Date(item.StartDate) && startdateGet <= new Date(item.EndDate)) {
                swal("Employee is unavailable due to being on Leave", "", "warning");
                leaveFlag = true;
            }
        });
            ...
            if (customerPhone === "" || customerPhone === "0") {
                ...
                if (smsCustomer || smsUser) {
                    if (!smsSettings || !smsSettings.twilioAccountId) {
                        ...
                        const companyName = localStorage.getItem("vs1companyName");
                        const productService = $("#product-list_GP4z5E8SpdZafRfLd").val();
    ...
    "click #btnEndActualTime": function () {
        ...
        if (paused == "Paused") {
            ...
            if (document.getElementById("tActualStartTime").value == "") {
                ...
                const selectedProduct = document.getElementById("product-list_GP4z5E8SpdZafRfLd").value;
    ...
    "submit form#frmAppointment": async function (event) {
        ...
        let selectedProduct = $("#product-list_GP4z5E8SpdZafRfLd").val() || "";
