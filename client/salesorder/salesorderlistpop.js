...
Template.salesorderslistpop.onCreated(()=>{
    ...
    let headerStructure = [
        ...
        { index: 8, label: "Employee", class: "colEmployee", active: true, display: true, width: "110" },
        { index: 9, label: "Converted", class: "colConverted", active: true, display: true, width: "110" },
        { index: 10, label: "Comments", class: "colComments", active: true, display: true, width: "300" },
