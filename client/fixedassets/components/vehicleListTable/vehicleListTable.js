...
import "./vehicleListTable.html";
import moment from "moment";
let sideBarService = new SideBarService();
let utilityService = new UtilityService();
let fixedAssetService = new FixedAssetService();

Template.vehicleListTable.onCreated(function () {
...
Template.vehicleListTable.onRendered(function () {
  $("#tblVehicleList tbody").on("click", "tr", function () {
    var assetID = $(this).closest("tr").attr("id");
    FlowRouter.go("/fixedassetcard?assetId=" + assetID);
  });
});

Template.vehicleListTable.events({
  ...
  "click .templateDownload": function () {
    let utilityService = new UtilityService();
    let rows = [];
    const filename = "vehicleList" + ".csv";
    rows[0] = [
      "Asset Name",
      "Asset Description",
      "Color",
  ...
  "click .templateDownloadXLSX": function (e) {
    ...
    window.location.href = "sample_imports/vehiclelist.xlsx";
  },
        ...
        if (results.data.length > 0) {
          if (
            ...
            setTimeout(async function () {
              ...
              await clearData("TFixedAssetsList");
              window.open("/vehiclelist?success=true", "_self");
            }, parseInt(dataLength));
            ...
            for (let i = 0; i < results.data.length - 1; i++) {
              ...
              objDetails = {
                ...
                PurchCost:
                  parseFloat(
                    results.data[i + 1][11].replace(/[^0-9.-]+/g, "")
                  ) || 0,
                SupplierName: "",
...
Template.vehicleListTable.helpers({
  tableheaderrecords: () => {
