...
import '../journalEntry/frm_journalentry_temp.html'
...
Template.journalentrycard_temp.onCreated(() => {
    ...
    let transactionheaderfields = [
        ...
        { label: "Entry No.", type: 'default', id: 'edtEntryNo', value: '', readonly: false, divClass: "col-12 col-md-6 col-lg-4 col-xl-2 transheader" },
        { label: 'Memo', type: 'default', id: 'txaMemo', value: '', readonly: false, divClass: "col-12 col-md-6 col-lg-4 col-xl-2 transheader" },
    ]
...
Template.journalentrycard_temp.onRendered(() => {
...
Template.journalentrycard_temp.onRendered(function () {
    ...
    templateObject.setJournalEntryData = (data) => {
...
Template.journalentrycard_temp.helpers({
    ...
    oneExAPIName: function () {
        let purchaseService = new PurchaseBoardService();
        return purchaseService.getOneJournalEnrtyData
    },
    ...
    setTransData: () => {
        let templateObject = Template.instance();
        return function (data) {
            let dataReturn = templateObject.setJournalEntryData(data)
            return dataReturn;
        }
    },
...
Template.journalentrycard_temp.events({
