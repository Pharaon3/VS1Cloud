...
Template.vatreturnlist.onCreated(function() {
    ...
    templateObject.getDataTableList = function(data) {
        ...
        let tab3startDate = "";
        let tab3endDate = "";
        if (data.fields.Tab1Year > 0 && data.fields.Tab1Month != "") {
            tab1startDate = data.fields.Tab1Year + "-" + months[data.fields.Tab1Month] + "-01";
            var endMonth = (data.fields.Tab1Type == "Quarterly") ? (Math.ceil(parseInt(months[data.fields.Tab1Month]) / 3) * 3) : (months[data.fields.Tab1Month]);
            tab1endDate = new Date(data.fields.Tab1Year, (parseInt(endMonth)), 0);
            tab1endDate = moment(tab1endDate).format("YYYY-MM-DD");
        }
        if (data.fields.Tab2Year > 0 && data.fields.Tab2Month != "") {
            tab2startDate = data.fields.Tab2Year + "-" + months[data.fields.Tab2Month] + "-01";
            var endMonth = (data.fields.Tab2Type == "Quarterly") ? (Math.ceil(parseInt(months[data.fields.Tab2Month]) / 3) * 3) : (months[data.fields.Tab2Month]);
            tab2endDate = new Date(data.fields.Tab2Year, (parseInt(endMonth)), 0);
            tab2endDate = moment(tab2endDate).format("YYYY-MM-DD");
        }
        if (data.fields.Tab3Year > 0 && data.fields.Tab3Month != "") {
            tab3startDate = data.fields.Tab3Year + "-" + months[data.fields.Tab3Month] + "-01";
            var endMonth = (data.fields.Tab3Type == "Quarterly") ? (Math.ceil(parseInt(months[data.fields.Tab3Month]) / 3) * 3) : (months[data.fields.Tab3Month]);
            tab3endDate = new Date(data.fields.Tab3Year, (parseInt(endMonth)), 0);
        ...
        var dataList = [
            ...
            data.fields.ID || '',
            data.fields.VATDesc || '',
            data.fields.Tab1Type,
            tab1startDate,
            tab1endDate,
            (tab2startDate != "" && tab2endDate != "") ? data.fields.Tab2Type : "",
            tab2startDate,
            tab2endDate,
            (tab3startDate != "" && tab3endDate != "") ? data.fields.Tab3Type : "",
            tab3startDate,
            tab3endDate,
    ...
    let headerStructure = [
        ...
        { index: 1, label: "VAT Number", class: "colVatNumber", width: "110", active: true, display: true },
        { index: 2, label: "Description", class: "colBasName", width: "300", active: true, display: true },
        { index: 3, label: "OUTPUT TAX\nPeriod", class: "t1Period", width: "110", active: true, display: true },
        { index: 4, label: "OUTPUT TAX\nFrom", class: "t1From", width: "110", active: true, display: true },
        { index: 5, label: "OUTPUT TAX\nTo", class: "t1To", width: "110", active: true, display: true },
        { index: 6, label: "INPUT TAX\nPeriod", class: "t2Period", width: "110", active: true, display: true },
        { index: 7, label: "INPUT TAX\nFrom", class: "t2From", width: "110", active: true, display: true },
        { index: 8, label: "INPUT TAX\nTo", class: "t2To", width: "110", active: true, display: true },
        { index: 9, label: "REFUND\nPeriod", class: "t3Period", width: "110", active: true, display: true },
        { index: 10, label: "REFUND\nFrom", class: "t3From", width: "110", active: true, display: true },
        { index: 11, label: "REFUND\nTo", class: "t3To", width: "110", active: true, display: true },
...
Template.vatreturnlist.events({
    "click .btnRefresh": function() {
        ...
        reportService.getAllVATReturn().then(function(data) {
            addVS1Data("TVATReturns", JSON.stringify(data)).then(function(datareturn) {}).catch(function(err) {
