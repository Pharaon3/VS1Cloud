...
Template.averagecostchart.onCreated(() => {
...
Template.averagecostchart.onRendered(() => {
  const templateObject = Template.instance();
  ...
  function drawBarChart(records) {
    ...
    try {
      var ctx = document.getElementById("chart_averagecostchartbar").getContext("2d");
  ...
  function drawPieChart(records) {
    ...
    try {
      var ctx = document.getElementById("chart_averagecostchart").getContext("2d");
