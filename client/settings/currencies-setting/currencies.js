...
Template.currenciessettings.onCreated(function () {
  ...
  let headerStructure = [
    ...
    { index: 1, label: 'Code', class: 'colCode', active: true, display: true, width: "100" },
    { index: 2, label: 'Currency', class: 'colCurrency', active: true, display: true, width: "110" },
    { index: 3, label: 'Symbol', class: 'colSymbol', active: true, display: true, width: "110" },
    ...
    { index: 8, label: 'Description', class: 'colDescription', active: true, display: true, width: "500" },
    { index: 9, label: 'Fixed Rate', class: 'colFixedRate', active: false, display: true, width: "110" },
      ...
      Papa.parse(templateObject.selectedFile.get(), {
          complete: function(results) {
              ...
              if (results.data.length > 0) {
                  ...
                  if (results.data[0][0] == "Code" && 
                      results.data[0][1] == "Currency" && 
                      results.data[0][2] == "Symbol" && 
                      results.data[0][3] == "Buy Rate" && 
                      results.data[0][4] == "Sell Rate" && 
                      results.data[0][5] == "Country" && 
                      results.data[0][6] == "Description") {
...
Template.currenciessettings.helpers({
  ...
  searchAPI: function() {
    return sideBarService.getOneCurrencyData;
  },
