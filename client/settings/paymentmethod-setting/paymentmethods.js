...
Template.paymentmethodSettings.onCreated(function () {
  ...
  let headerStructure = [
    ...
    { index: 1, label: 'Payment Method Name', class: 'colName', active: true, display: true, width: "1300" },
    { index: 2, label: 'Is Credit Card', class: 'colIsCreditCard', active: true, display: true, width: "200" },
