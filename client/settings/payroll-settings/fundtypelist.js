...
Template.fundtypelistpop.onCreated(() => {
    ...
    let headerStructure = [
        { index: 0, label: "ID", class: "colfundID", active: false, display: true, width: "10", },
        { index: 1, label: "Name", class: "colfundDescription", active: true, display: true, width: "200" },
...
Template.fundtypelistpop.helpers({
    ...
    apiFunction: function () {
      ...
      return sideBarService.getSuperType;
    },
  
    searchAPI: function () {
      let sideBarService = new SideBarService();
      return sideBarService.getOneFundTypeByName;
    },
    ...
    tablename: () => {
      ...
      return 'tblfundtypelist'+ accCustID;
    },
});
