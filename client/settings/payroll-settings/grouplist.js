...
Template.grouptypelistpop.onCreated(() => {
    ...
    let headerStructure = [
        { index: 0, label: "ID", class: "colgroupID", active: false, display: true, width: "10", },
        { index: 1, label: "Name", class: "colgroupDescription", active: true, display: true, width: "300" },
...
Template.grouptypelistpop.events({
    ...
    'click .lineDescription': function(event) {
        $('#tblgrouplist tbody tr .lineDescription').attr("data-toggle", "modal");
        $('#tblgrouplist tbody tr .lineDescription').attr("data-target", "#groupTypeListModel");
    ...
    'click #groupTypeListModel #refreshpagelist': function() {
        ...
        templateObject.getDataTableList();
