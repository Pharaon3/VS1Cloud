...
Template.leadstatussettings.onCreated(function() {
    ...
    let headerStructure = [
        ...
        { index: 1, label: 'Type Code', class: 'colLeadTypeCode', active: true, display: true, width: "200" },
        ...
        { index: 4, label: 'Is Default', class: 'colIsDefault', active: true, display: true, width: "200" },
