...
Template.departmentSettings.onCreated(function(){
    ...
    let headerStructure = [
      ...
      { index: 4, label: 'Header Department', class: 'colHeaderDept', active: false, display: true, width: "200" },
      { index: 5, label: 'Full Department Name', class: 'colFullDeptName', active: false, display: true, width: "200" },
      { index: 6, label: 'Department Tree', class: 'colDeptTree', active: false, display: true, width: "200" },
      { index: 7, label: 'Site Code', class: 'colSiteCode', active: true, display: true, width: "110" },
                        ...
                        setTimeout(function() {
                            ...
                            sideBarService
                                    ...
                                    .then(function(dataReload) {
                                        addVS1Data("TDeptClass", JSON.stringify(dataReload))
