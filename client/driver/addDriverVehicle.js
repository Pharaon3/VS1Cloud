...
Template.addDriverVehicle.onCreated(function () {
    ...
    templateObject.getTransactionDataTableList = function(data) {
        var dataList = [
            data.fields.ID || "",
            data.fields.SaleDate ? moment(data.fields.SaleDate).format("YYYY/MM/DD") : "",
            data.fields.ID || "",
            ...
            utilityService.modifynegativeCurrencyFormat(data.fields.TotalBalance)|| 0.00,
            data.fields.SaleCustField1 || "",
            data.fields.SaleCustField2 || "",
            data.fields.Employee || "",
            data.fields.Comments || "",
            data.fields.Deleted ? "Deleted" : "",
        ];
        return dataList;
    }
...
Template.addDriverVehicle.onRendered(function () {
    let begunDate;
    let currentDate;
    LoadingOverlay.show();
...
Template.addDriverVehicle.helpers({
