...
export class UtilityService {
    ...
    attachmentUpload = function(uploadedFilesArray, myFiles, saveToTAttachment, lineIDForAttachment, custid='') {
        let empName = localStorage.getItem('mySession');
        let totalAttachments = uploadedFilesArray.length;
        let elementid= '#file-display';
        if(custid != '') {
            ...
            if (!saveToTAttachment) {
                ...
                if (lineIDForAttachment) {
                    if (!$('#attachment-tooltip-' + lineIDForAttachment + ' .uploaded-element').length) {
                        $('#attachment-tooltip-' + lineIDForAttachment + ' '+elementid).html(elementForItem);
                    } else {
                        $('#attachment-tooltip-' + lineIDForAttachment + ' '+elementid).append(elementForItem);
                    }
