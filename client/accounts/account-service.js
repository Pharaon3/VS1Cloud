...
export class AccountService extends BaseService {
    ...
    getExpanseClaimList(dateFrom, dateTo, ignoreDate, limitCount, limitFrom, deleteFilter) {
        let options = "";
        if (ignoreDate == true) {
            options = {
                ListType: "Detail",
    ...
    getExpanseClaimListByEmployeeName(employeeName) {
        let options = {
            ListType: "Detail",
            IgnoreDates: true,
            Search: "Active=true and RequestToEmployeeName = '" + employeeName + "'",
        };
        return this.getList(this.ERPObjects.TExpenseClaimList, options);
    }

    getExpanseClaimListById(expenseId) {
        let options = {
            ListType: "Detail",
            IgnoreDates: true,
            Search: "Active=true and ExpenseClaimID = '" + expenseId + "'",
        };
        return this.getList(this.ERPObjects.TExpenseClaimList, options);
    }
