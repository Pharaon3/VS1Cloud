...
import './accountlistpopwithswitch.html';
import moment from "moment";

let sideBarService = new SideBarService();
let utilityService = new UtilityService();
var times = 0;
Template.accountlistpopwithswitch.onCreated(() => {
    ...
    templateObject.getDataTableList = function(data) {
        ...
        let chkBoxId = "t-" + pan + "-" + data.AccountID;
    ...
    let headerStructure = [
        ...
        { index: 1, label: 'ID', class: 'colAccountId', active: false, display: true, width: "10" },
        ...
        { index: 4, label: 'Account No', class: 'colAccountNo', active: true, display: true, width: "80" },
...
Template.accountlistpopwithswitch.onRendered(function() {
    const templateObject = Template.instance();
...
Template.accountlistpopwithswitch.helpers({
    creditrecord: () => {
...
Template.accountlistpopwithswitch.events({
