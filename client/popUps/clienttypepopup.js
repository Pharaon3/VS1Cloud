...
Template.clienttypepopup.onCreated(function() {
    ...
    templateObject.getDataTableList = function(data){
        ...
        let headerStructure = [
            ...
            { index: 2, label: 'Description', class: 'colDescription', active: true, display: true, width: "400" },
            ...
            { index: 5, label: 'Grace Period', class: 'colGracePeriodtus', active: true, display: true, width: "110" },
...
Template.clienttypepopup.events({
    ...
    'click .btnAddNewClientType': function (event) {
        ...
        // $('div#myModalClientType').modal('show');
            $('#myModalClientType').find('#edtClientTypeID').val('');
            $('#myModalClientType').find('#edtClientTypeName').val('');
            $('#myModalClientType').find('#txaDescription').val('');
            $('#myModalClientType').find('#add-clienttype-title').text('Add Customer Type');
    },
