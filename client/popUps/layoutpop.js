...
Template.layoutpop.onCreated(function(){
    ...
    let headerStructure = [
        { index: 0, label: "ID", class: "colID", width: "80", active: false, display: true },
        ...
        { index: 3, label: "Current Layout", class: "colCurrentLayout", width: "100", active: false, display: false },
        { index: 4, label: "Status", class: "colStatus", width: "100", active: true, display: true },
    ];
...
Template.layoutpop.helpers({
    ...
    searchAPI: function() {
        return reportService.searchPNLLayout;
    },
