...
Template.termlistpop.onCreated(function() {
    ...
    let headerStructure  = [
        { index: 0, label: 'ID', class: 'colTermsID', active: false, display: true, width: "60" },
        ...
        { index: 5, label: 'Description', class: 'colDescription', active: true, display: true, width: "400" },
...
Template.termlistpop.events({
    ...
    "click #tblTermsList tbody tr": (e) => {
        ...
        const termAmount = $(e.currentTarget).find("td.colTermsAmount").text();
        $('#selectTermAmount').val(termAmount);
    },
    ...
    //     }
    // }
    'click .closeTermsPop': function () {
        $('#termPopModal').modal('hide');
    },
});
