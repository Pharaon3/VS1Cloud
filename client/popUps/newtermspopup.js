...
Template.newtermspop.onCreated(async function() {
    ...
    templateObject.displayrecord = new ReactiveVar();
...
Template.newtermspop.onRendered(async function() {
    ...
    $('#tblTermsList tbody').on('click', 'tr .colName, tr .colIsDays, tr .colIsEOM, tr .colDescription, tr .colIsCOD, tr .colIsEOMPlus, tr .colCustomerDef, tr .colSupplierDef', function(event) {
