...
Template.currencypop.events({
  ...
  //   }
    ...
    // }
  // },
  'click .btnAddNewCurrency':function(event){
    $('div#newCurrencyModal').modal("show");
        // $('#newCurrencyModal').find('#edtCurrencyID').val('');
        // $('#newCurrencyModal').find('#edtCurrencyName').val('');
        // $('#newCurrencyModal').find('#currencySymbol').val('');
        // $('#newCurrencyModal').find('#currencyCode').val('');
        // $('#newCurrencyModal').find('#sedtCountry').val('');
        // $('#newCurrencyModal').find('#add-currency-title').text('Add New Currency');
  },
...
Template.currencypop.helpers({
  ...
  //   let sn = templateObject.data.sn ? templateObject.data.sn : Math.floor(Math.random() * 100);
  //   return 'tblCurrencyPopList'+ CustID + sn;
  // },
});
