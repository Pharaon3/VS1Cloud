...
Template.mobileapp.events({
    ...
    'click #mobileBtnEnter': function(e, instance) {  // Click enter button
        ...
        if(inputStatus == "enterEmployee") {
            ...
            let empId ;
            let emp_name ;
            let input_number_check = true;


            if (typeof parseInt(empString) === 'number' && !isNaN(parseInt(empString))) {
                empId = empString;
            ...
            getVS1Data('TEmployee').then(function (dataObject) {
                ...
                if(input_number_check == true) {
                    for(var i = 0; i < employData.temployee.length; i ++) {
                        if (employData.temployee[i].fields.ID == empId) {
                            checkEmpId = true;
                            templateObject.employeeNameData.set(employData.temployee[i].fields.EmployeeName);
                            templateObject.employeeIdData.set(empId); 
                    ...
                    for(var i = 0; i < employData.temployee.length; i ++) {
                        if (employData.temployee[i].fields.EmployeeName == emp_name) {
                            checkEmpId = true;
                            templateObject.employeeNameData.set(emp_name);
                            templateObject.employeeIdData.set(employData.temployee[i].fields.ID); 
                        } else {
                            $('.mobile-header-status-text').text('Employee Name is not correct. Please select correct Number');
                            $(".mobile-main-input").val("");
                        }
                    }
                }    
                ...
                if(checkEmpId == true)
                {
                    ...
                    $('.mobile-header-status-text').text('Successfully Set Employee');
