...
Template.new_process.onCreated(() => {
    ...
    templateObject.HourlyLabourCost = new ReactiveVar('$100.00');
...
Template.new_process.onRendered(() => {
    ...
    templateObject.getHourlyRate = function() {
        getVS1Data(erpObject.TEarnings).then(function(dataObject) {
            if(dataObject.length == 0) {
                let data = sideBarService.getEarnings;
            }else {
                let data = JSON.parse(dataObject[0].data);
                let hourly_rate = '$100.00' ;
                templateObject.HourlyLabourCost.set(hourly_rate)
            }
        } )
    }
    templateObject.getHourlyRate();
    ...
    templateObject.getProcessDetail  = function() {
        ...
        let objDetail = {};
        let hourlyCost = templateObject.HourlyLabourCost.get();
            ...
            getVS1Data('TProcessStep').then(function(dataObject){
                if(dataObject.length == 0) {
                    ...
                    for(let i = 0; i< useData.length; i++) {
                        ...
                        // objDetail.COGS = "Manufacturing Labour" ;
                        // objDetail.ExpenseAccount = "Manufacturing Labour" ;
                        // objDetail.OCOGS = "Manufacturing Labour Off Set" ;
                        // objDetail.OExpense = 'Manufacturing Labour Off Set';
                        //  objDetail.Wastage = 'Manufacturing Wastage';
             ...
             objDetail = {
                        ...
                        ExpenseAccount: 'Manufacturing Labour',
                        OHourlyCost: '$0.00',
                        OCOGS: 'Manufacturing Labour Off Set',
