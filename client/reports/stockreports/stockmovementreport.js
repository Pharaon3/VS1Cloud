...
Template.stockmovementreport.onCreated(() => {
  ...
  let reset_data = [
    { index: 0, label: "ID", class: "colLineId", active: false, display: true, width: "20", calc: false },
    { index: 1, label: "Product", class: "colProductID", active: true, display: true, width: "200", calc: false },
    { index: 2, label: "Trans Date", class: "colTrDate", active: true, display: true, width: "120", calc: false },
    { index: 3, label: "Trans Type", class: "colTrType", active: true, display: true, width: "100", calc: false },
    { index: 4, label: "Trans No", class: "colTrNo", active: true, display: true, width: "100", calc: false },
    { index: 5, label: "Opening Qty", class: "colOpening", active: true, display: true, width: "100", calc: false },
    { index: 6, label: "Trans Qty", class: "colCurrent", active: true, display: true, width: "100", calc: false },
    { index: 7, label: "Running Qty", class: "colRunning", active: true, display: true, width: "100", calc: false },
    { index: 8, label: "Unit Cost", class: "colAmUnitCost text-right", active: true, display: true, width: "110", calc: true },
    { index: 9, label: "Total Cost", class: "colAvTotalCost text-right", active: true, display: true, width: "110", calc: true },
  ];
  ...
  templateObject.getReportDataRecord = function (data) {
    ...
    if (data != "") {
      dataList = [
        data.fields.Lines[0].fields.ProductName || "",
        GlobalFunctions.generateSpan(GlobalFunctions.formatDate(data.fields.Lines[0].fields.TransDate), "text-primary") || "",
        data.fields.Lines[0].fields.PQA.fields.TransType || "",
        data.fields.Lines[0].fields.PQA.fields.ID || 0,
        "",
        "",
        "",
        data.fields.Lines[0].fields.Cost || 0,
        data.fields.Lines[0].fields.Value || 0,
      ];
    } else {
      dataList = ["", "", "", 0, "", "", "", 0, 0];
    }
...
Template.stockmovementreport.onRendered(() => {
  ...
  //     getVS1Data("TProductMovementList")
  //       .then(function (dataObject) {
  //         if (dataObject.length == 0) {
  //           reportService
  //             .getStockMovementReport(dateFrom, dateTo, ignoreDate)
  ...
  //       });
  //   };
  //   templateObject.getReportData(GlobalFunctions.convertYearMonthDay($("#dateFrom").val()), GlobalFunctions.convertYearMonthDay($("#dateTo").val()), false);
  ...
  //       else return a.fields.Lines[0].fields.ProductName < b.fields.Lines[0].fields.ProductName ? -1 : 1;
  //     }
...
Template.stockmovementreport.events({
  "click #tblStockMovement tbody tr": function (event) {},
...
Template.stockmovementreport.helpers({
  ...
  apiFunction: function () {
    return reportService.getStockMovementReport;
  },
  ...
  searchFunction: function () {
    return reportService.getStockMovementDataByKeyword;
  },
