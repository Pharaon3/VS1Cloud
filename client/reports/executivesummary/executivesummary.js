...
Template.executivesummaryreport.onCreated(function () {
  ...
  let reset_data = [
    ...
    { index: 1, label: "Cash", class: "colCash", active: true, display: true, width: "200", calc: false },
    { index: 2, label: "Profitability", class: "colProfitability", active: true, display: true, width: "200", calc: false },
    { index: 3, label: "Performance", class: "colPerformance", active: true, display: true, width: "200", calc: false },
    { index: 4, label: "Balance", class: "colBalance", active: true, display: true, width: "200", calc: false },
    { index: 5, label: "Income", class: "colIncome", active: true, display: true, width: "200", calc: false },
    { index: 6, label: "Position", class: "colPosition", active: true, display: true, width: "200", calc: true },
  ];
  templateObject.displaysettings.set(reset_data);
  templateObject.getReportDataRecord = function (data) {
    var dataList = [];
    if (data != "") {
      dataList = [data.ID || "", data.Cash || 0, data.Profitability || "", data.Performance || "", data.Balance || 0, data.Income || 0, data.Position || ""];
    } else {
      dataList = ["", 0, "", "", 0, 0, ","];
    }
    return dataList;
...
Template.executivesummaryreport.events({
  "click #tblExecutiveSummary tbody tr": function (event) {
  },
...
Template.executivesummaryreport.helpers({
  ...
  searchFunction: function () {
    return reportService.getExecutiveSummaryByKeyword;
  },
