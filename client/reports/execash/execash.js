...
Template.execashreport.onRendered(() => {
  ...
  //   templateObject.getCashReports(GlobalFunctions.convertYearMonthDay($("#dateFrom").val()), false);
...
Template.execashreport.helpers({
  ...
  searchFunction: function () {
    return reportService.getCashReportByKeyword;
  },
  //   titleMonth1: () => {
...
Template.execashreport.events({
  "click #tblCashExecutive tbody tr": function (event) {
  },
