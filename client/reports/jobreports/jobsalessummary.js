...
Template.jobsalessummary.onCreated(() => {
  ...
  let reset_data = [
    ...
    { index: 1, label: "Customer", class: "colCustomer", active: true, display: true, width: "200", calc: false },
    { index: 2, label: "Job Customer", class: "colJobCustomer", active: true, display: true, width: "200", calc: false },
    { index: 3, label: "Job Number", class: "colJobNumber", active: true, display: true, width: "80", calc: false },
    { index: 4, label: "Job Name", class: "colJobName", active: true, display: true, width: "200", calc: false },
    { index: 5, label: "Product Name", class: "colProductID", active: true, display: true, width: "200", calc: false },
    { index: 6, label: "Qty Shipped", class: "colQtyShipped", active: true, display: true, width: "100", calc: false },
    { index: 7, label: "Discount", class: "colDiscount", active: true, display: true, width: "110", calc: false },
    { index: 8, label: "Tax", class: "colTax text-right", active: true, display: true, width: "110", calc: true },
    { index: 9, label: "Amount (ex)", class: "colAmountEx text-right", active: true, display: true, width: "110", calc: true },
    { index: 10, label: "Amount (inc)", class: "colAmountInc text-right", active: true, display: true, width: "110", calc: true },
  ];
...
Template.jobsalessummary.onRendered(() => {
  ...
  //     getVS1Data("TJobSalesSummary")
  //       .then(function (dataObject) {
  //         if (dataObject.length == 0) {
  //           reportService
  //             .getJobSalesSummaryReport(dateFrom, dateTo, ignoreDate)
  ...
  //       deleteFilter = false;
  //     }
  //     var dataList = [GlobalFunctions.generateSpan("Other", "table-cells text-bold"), "", "", "", "", "", "", "", "", ""];
...
Template.jobsalessummary.events({
  "click #tblJobSalesSummary tbody tr": function (event) {},
  ...
  //           }
  //         } else {
  //           if (reportData.FormID == 225) Meteor.call("sendNormalEmail", reportData);
  //         }
  //       }
  //     });
  ...
  //   let templateObject = Template.instance();
  //   localStorage.setItem("VS1JobSalesSummary_Report", "");
  //   templateObject.loadReport(GlobalFunctions.convertYearMonthDay($("#dateFrom").val()), GlobalFunctions.convertYearMonthDay($("#dateTo").val()), false);
  // },
...
Template.jobsalessummary.helpers({
  ...
  searchFunction: function () {
    return reportService.getJobSalesSummaryDataByKeyword;
  },
