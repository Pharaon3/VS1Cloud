...
Template.jobprofitabilityreport.onCreated(() => {
  ...
  let reset_data = [
    ...
    { index: 2, label: "Job Name", class: "colJobName", active: true, display: true, width: "200", calc: false },
    { index: 3, label: "Job No", class: "colJobNo", active: true, display: true, width: "80", calc: false },
    { index: 4, label: "Cost (ex)", class: "colCostEX text-right", active: true, display: true, width: "110", calc: true },
    { index: 5, label: "Income (ex)", class: "colIncomeEX text-right", active: true, display: true, width: "110", calc: true },
    { index: 6, label: "Quoted (ex)", class: "colQuotedEX text-right", active: true, display: true, width: "110", calc: true },
    { index: 7, label: "Diff Inc Cost", class: "colDiffIncCost text-right", active: true, display: true, width: "110", calc: true },
    { index: 8, label: "BackOrders", class: "colBackOrders", active: true, display: true, width: "80", calc: false },
    { index: 9, label: "Credit", class: "colCredit text-right", active: true, display: true, width: "80", calc: true },
    { index: 10, label: "Profit %", class: "colProfitPercent", active: true, display: true, width: "120", calc: false },
...
Template.jobprofitabilityreport.onRendered(() => {
  ...
  //     templateObject.setDateAs(dateFrom);
  //     getVS1Data("TJobProfitability")
  //       .then(function (dataObject) {
  //         if (dataObject.length == 0) {
  //           reportService
  //             .getJobProfitabilityReport(dateFrom, dateTo, ignoreDate)
  ...
  //       return tmp >= 0
  //         ? GlobalFunctions.generateSpan(GlobalFunctions.showCurrency(tmp), "text-success", "text-right")
  //         : GlobalFunctions.generateSpan(GlobalFunctions.showCurrency(tmp), "text-danger", "text-right");
  //     }
  //     for (let i = 0; i < splashArrayReport.length; i++) {
  //       if (T_AccountName != splashArrayReport[i][0]) {
  //         T_AccountName = splashArrayReport[i][0];
  //         customerProductReport.push([GlobalFunctions.generateSpan(`${T_AccountName}`, "table-cells text-bold"), "", "", "", "", "", "", "", "", "", ""]);
  //       }
  //       T_AccountName = splashArrayReport[i][0];
...
Template.jobprofitabilityreport.events({
  "click #tblJobProfitability tbody tr": function (event) {},
...
Template.jobprofitabilityreport.helpers({
  ...
  searchFunction: function () {
    return reportService.getJobProfitabilityDataByKeyword;
  },
  //   dateAsAt: () => {
