...
Template.accountant_trust.helpers({
    ...
    accountantId: () => {
        return Template.instance().accountantId.get();
    },
    accountantEmailAddress: () => {
        return Template.instance().accountantEmailAddress.get();
    },
    accountantFirstName: () => {
        return Template.instance().accountantFirstName.get();
    },
    accountantMiddleName: () => {
        return Template.instance().accountantMiddleName.get();
    },
    accountantLastName: () => {
        return Template.instance().accountantLastName.get();
    },
    accountantPhoneNumber: () => {
        return Template.instance().accountantPhoneNumber.get();
    },
    accountantCompanyType: () => {
        return Template.instance().accountantCompanyType.get();
    },
    yearEnd: () => {
        return Template.instance().yearEnd.get();
    },
});
