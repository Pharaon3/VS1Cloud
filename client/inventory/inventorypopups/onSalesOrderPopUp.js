...
Template.onSalesOrderPopUp.onCreated(function () {
  ...
  let headerStructure = [
    ...
    { index: 2, label: "Type", class: "Type", active: true, display: true, width: "130" },
    { index: 3, label: "Ref", class: "Ref", active: true, display: true, width: "30" },
    { index: 4, label: "Qty", class: "Qty", active: true, display: true, width: "30" },
    { index: 5, label: "Total Running", class: "TotalRunning", active: true, display: true, width: "30" },
    { index: 6, label: "Unit Price", class: "UnitPrice", active: true, display: true, width: "80" },
    { index: 7, label: "Total", class: "Total", active: true, display: true, width: "80" },
    { index: 8, label: "Status", class: "Status", active: true, display: true, width: "30" },
  ];

  templateObject.tableheaderrecords.set(headerStructure);
});

Template.onSalesOrderPopUp.onRendered(function () {
  $(".fullScreenSpin").css("display", "inline-block");

});

Template.onSalesOrderPopUp.helpers({
  datatablerecords: () => {
...
Template.onSalesOrderPopUp.events({
