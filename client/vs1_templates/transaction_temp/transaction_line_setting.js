...
export default class TransactionFields {
    ...
    static initPurchaseOrderLine = [
        ...
        { index: 5,  label: "Customer/Job",        class: "CustomerJob",   width: "110",       active: false,   display: true },
    ...
    static initQuoteLine = [
        ...
        { index: 3,  label: "Price (Ex)",     class: "UnitPriceEx",   width: "152",       active: true,   display: true },
        { index: 4,  label: "Price (Inc)",    class: "UnitPriceInc",  width: "152",       active: false,  display: true },
        { index: 5,  label: "Disc %",              class: "Discount",      width: "95",        active: true,   display: true },
        { index: 6,  label: "Cost",          class: "CostPrice",     width: "110",       active: false,   display: true },
    ...
    static initInvoiceLine = [
        ...
        { index: 2,  label: "Qty",                 class: "Qty",           width: "55",        active: true,   display: true },
        { index: 3,  label: "Disc %",              class: "Discount",      width: "75",        active: true,   display: true },
        { index: 4,  label: "Cost",                class: "CostPrice",     width: "110",       active: false,   display: true },
        ...
        { index: 9,  label: "Tax Rate",           class: "TaxRate",        width: "95",        active: false,   display: true },
        { index: 10,  label: "Price (Ex)",          class: "UnitPriceEx",   width: "95",       active: true,   display: true },
        { index: 11,  label: "Price (Inc)",         class: "UnitPriceInc",  width: "95",       active: false,  display: true },
        { index: 12, label: "Tax Amt",            class: "TaxAmount",      width: "95",        active: true,   display: true },
        { index: 13, label: "Shipping Totals",      class:"ShippingTotals",       width: "95",        active: false,  display: true },
        { index: 14, label: "Amount (Ex)",        class: "AmountEx",       width: "120",       active: true,   display: true },
        { index: 15, label: "Amount (Inc)",       class: "AmountInc",      width: "120",       active: false,  display: true },
        { index: 16, label: "Units",              class: "Units",          width: "95",        active: false,   display: true },
        { index: 17,  label: "Custom Field 1",     class: "CustomField1",  width: "124",       active: false,  display: true },
        { index: 18,  label: "Custom Field 2",     class: "CustomField2",  width: "124",       active: false,  display: true },
    ];
    ...
    static initChequeLine = [
        { index: 0,  label: "Account Name",        class: "AccountName",   width: "200",       active: true,   display: true },
        { index: 1,  label: "Memo",         class: "Memo",   width: "",       active: true,   display: true },
        { index: 2,  label: "Amount (Ex)",     class: "AmountEx",   width: "152",       active: true,   display: true },
        { index: 3,  label: "Amount (Inc)",    class: "AmountInc",  width: "152",       active: false,  display: true },
        { index: 4,  label: "Tax Code",           class: "TaxCode",        width: "95",        active: true,   display: true },
        { index: 5,  label: "Tax Rate",           class: "TaxRate",        width: "95",        active: true,   display: true },
        { index: 6, label: "Tax Amt",            class: "TaxAmount",      width: "95",        active: true,   display: true },
        { index: 7, label: "Custom Field 1",        class: "CustomField1",       width: "140",       active: false,   display: true },
        { index: 8, label: "Custom Field 2",       class: "CustomField2",      width: "140",       active: false,  display: true },
    ]
