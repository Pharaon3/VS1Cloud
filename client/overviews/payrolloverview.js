...
import '../overviews/payroll/modal/PayrollCustomerListModal.html';
import '../contacts/payrollcalendarpop.html';
import './payroll/PayrollOverviewPayrun.html';
...
Template.payrolloverview.events({
  ...
  "click #payrollleave": function (event) {
    $(".modal-backdrop").css('display', 'none');
    FlowRouter.go("/payrollleave");
  },

  "click #btnProcessClock": function (event) {
    $('.modal-backdrop').css('display', 'none');
