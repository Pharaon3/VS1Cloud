...
Template.AddPayRunModal.onRendered(() => {
  ...
  {
    $("#selectAPayRun").append("<option value='"+Calendardata[k].fields.ID +"'>" + Calendardata[k].fields.PayrollCalendarPayPeriod+ " : " + moment(Calendardata[k].fields.PayrollCalendarFirstPaymentDate).format('DD/MM/YYYY') + "</option>");
  }
