        ...
        if (previous_url !== "" && previous_url !== context.path && JSON.parse(localStorage.getItem("isFormUpdated"))) {
            ...
            swal({
                ...
                if (result.value) {
                    ...
                    if(previous_url === "/appointments" || previous_url === "/dashboardsalesmanager" || previous_url === "/dashboardsales"){
                        $(document).find(".btn-auto-save-calendar").click();
                    }else{
...
authenticatedRoutes.route('/deliveryoverview', {
    name: 'deliveryoverview',
    action() {
        BlazeLayout.render('layout', {
            yield: 'deliveryoverview'
        });
    }
});
...
authenticatedRoutes.route('/drivervehiclelist', {
...
authenticatedRoutes.route('/vehiclelist', {
    name: 'vehiclelist',
    action() {
        BlazeLayout.render('layout', {
            yield: 'vehiclelist'
...
authenticatedRoutes.route('/accountantsettings', {
    name: 'accountantsettings',
    action() {
        BlazeLayout.render('layout', {
            yield: 'accountantsettings'
        });
    }
});
...
authenticatedRoutes.route('/manifestlist', {
    name: 'manifestlist',
    action() {
        BlazeLayout.render('layout', {
            yield: 'manifestlist'
