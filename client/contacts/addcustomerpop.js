...
Template.addcustomerpop.onRendered( async function() {
    ...
    templateObject.getCustomerData = async function() {
        ...
        if(templateObject.data.name != undefined && templateObject.data.name !== "") {
        ...
        } else if (templateObject.data.id != undefined && templateObject.data.id !== "") {
...
Template.addcustomerpop.events({
    ...
    'click .addcustomerpop .btnSaveCustPOP': async function(event) {
        ...
        setTimeout(async function() {
            ...
            let bankAccountNumber = $('.addcustomerpop #edtAccountNumber').val();
