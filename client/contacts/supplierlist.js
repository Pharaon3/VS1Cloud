...
Template.supplierlist.onCreated(function() {
    ...
    let headerStructure = [
        ...
        {index: 3, label: 'Mobile', class: 'colMobile', active: false, display: true, width: "110"},
        {index: 4, label: 'Email', class: 'colEmail', active: false, display: true, width: "200"},
        ...
        { index: 10, label: 'City/Suburb', class: 'colSuburb', active: true, display: true, width: "110" },
        { index: 11, label: 'Country', class: 'colCountry', active: true, display: true, width: "110" },
