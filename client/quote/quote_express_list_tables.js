...
Template.quoteslist.onCreated(function(){
    ...
    let headerStructure = [
        ...
        { index: 4, label: "Customer", class: "colCustomer", active: true, display: true, width: "110" },
        ...
        { index: 9, label: "Converted", class: "colConverted", active: false, display: true, width: "40" },
