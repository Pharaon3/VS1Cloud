...
let headerStructure = [
    ...
    { index: 7, label: 'Bank Name', class: 'colBankName', active: false, display: true, width: "200" },
    { index: 8, label: 'Bank Acc Name', class: 'colBankAccountName', active: true, display: true, width: "200" },
    ...
    { index: 12, label: 'Expiry Date', class: 'colExpiryDate', active: false, display: true, width: "80" },
